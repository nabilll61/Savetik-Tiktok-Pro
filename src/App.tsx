...
export default function App() {
  ...
  const [activeView, setActiveView] = useState<'downloader' | 'guide' | 'restrictions' | 'donation' | 'history'>('downloader');
  const [theme, setTheme] = useState<'light' | 'dark'>(() => {
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('savetik-theme');
  ...
  useEffect(() => {
    ...
    localStorage.setItem('savetik-theme', theme);
  }, [theme]);
    ...
    <div className="min-h-screen bg-neo-bg text-neo-text flex flex-col justify-between transition-colors">
      ...
      <main className="flex-grow pb-16">
        ...
        {activeView === 'guide' ? (
          ...
          /* Donation View */
          <DonationSection onBack={() => setActiveView('downloader')} />
        ) : activeView === 'history' ? (
          /* History View */
          <HistorySection 
              ...
              <div className="bg-neo-bg-sec border-3 border-neo-border p-6 md:p-10 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
                  <div className="space-y-2">
                    ...
                    <h4 className="font-heading font-black uppercase text-sm tracking-wide text-neo-text">Salin Tautan Video</h4>
                    <p className="text-xs text-neo-text opacity-80 leading-relaxed font-semibold">
                      Buka aplikasi TikTok atau YouTube. Klik bagikan lalu salin tautan video (URL) yang ingin Anda simpan ke perangkat.
                    </p>
                  </div>

                  <div className="space-y-2">
                    <div className="font-heading font-black text-2xl text-[#E11D48]">02.</div>
                    <h4 className="font-heading font-black uppercase text-sm tracking-wide text-neo-text">Tempel & Ekstrak</h4>
                    <p className="text-xs text-neo-text opacity-80 leading-relaxed font-semibold">
                  ...
                  <div className="space-y-2">
                    ...
                    <h4 className="font-heading font-black uppercase text-sm tracking-wide text-neo-text">Unduh Langsung</h4>
                    <p className="text-xs text-neo-text opacity-80 leading-relaxed font-semibold">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-4">
              ...
              <p className="text-xs text-neo-text opacity-70 leading-relaxed font-semibold max-w-sm">
                SaveTik adalah platform ekstraktor video modern yang dirancang khusus dengan system design Neo-Brutalism berkecepatan tinggi untuk kebutuhan pengunduhan media Anda.
              </p>
            <div className="text-[10px] font-mono text-neo-text opacity-50 font-black uppercase">
              SISTEM AKTIF: UTC-7 ● ONLINE
            </div>
          </div>
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-4">
            <div>
              <h5 className="font-heading font-black text-xs uppercase tracking-wider mb-3 text-neo-text">Dukungan Platform</h5>
            ...
            <div>
              <h5 className="font-heading font-black text-xs uppercase tracking-wider mb-3 text-neo-text">Kebijakan</h5>
              <ul className="space-y-2 text-xs font-semibold text-neo-text opacity-70">
                ...
                <li className="hover:text-[#E11D48] transition-colors"><a href="#">Hubungi Admin</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col justify-between items-start md:items-end">
            <div className="inline-block bg-[#E2F7F2] dark:bg-[#1A3A34] neo-border-thin px-3 py-1.5 rounded-[4px] text-[10px] font-black uppercase text-[#14B8A6]">
