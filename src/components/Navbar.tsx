...
interface NavbarProps {
  activeView: 'downloader' | 'guide' | 'restrictions' | 'donation' | 'history' | 'feedback';
  onViewChange: (view: 'downloader' | 'guide' | 'restrictions' | 'donation' | 'history' | 'feedback') => void;
  theme: 'light' | 'dark';
  onThemeToggle: () => void;
}
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full text-left block py-3 px-4 font-black text-xs neo-border shadow-neo-btn transition-all active:translate-y-0.5 cursor-pointer uppercase tracking-wider ${
                    activeView === 'feedback' ? 'bg-neo-bg-sec text-[#6366F1]' : 'bg-neo-card text-neo-text'
                  }`}
                >
                  💬 LAPOR BUG & FEEDBACK
                </button>
